...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		['Tutorial'],
		['Bacons-are-number-one', 'OofRave', 'Ooferita'],
		['Guest-Dance', 'Scary-Wings'],
		['FnfThing', 'Roblox-VS-FNF', 'Oof-Town-Road'],
		['Psycho-Pig'],
		['Nova-Technology', 'Rockin-That-Bass', 'Winter-Horrorland']
	];
